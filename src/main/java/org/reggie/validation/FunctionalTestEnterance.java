...
import org.reggie.validation.xml.node.ExecutiontimeNode;
...
public class FunctionalTestEnterance {
	...
	public static void main(String[] args) throws JAXBException, IOException {
		...
		// Create result #3
		SuccessNode ses_3 = new SuccessNode("yes", "100");
		ExecutiontimeNode perfer_node_3 = new ExecutiontimeNode("1.12", true);
		...
		File file = new File(dir,"\\build\\test-results\\functional_test.xml");
		if (!file.exists()) {
